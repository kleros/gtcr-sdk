...
describe('GTCRFactory', () => {
  ...
  let externalProvider: ethers.providers.ExternalProvider | ethers.providers.JsonRpcFetchFunc
  ...
  it('Fetches deployed TCR addresses', async () => {
    ...
    expect(await gtcrFactory.getTCRAddresses()).to.be.a.instanceOf(Array).and.of.length(NUM_TCRS)
  })  
})
